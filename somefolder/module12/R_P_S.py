...
def main_menu():
    ...
    window.title("Wonder Game")
    button1 = tk.Button(text="       rock_paper_scissors       ",bg="skyblue",command=rock_paper_scissors)
    button1.grid(column=0,row=1)
    button2 = tk.Button(text="       guess_the_number      ",bg="pink",command=guess_the_number)
